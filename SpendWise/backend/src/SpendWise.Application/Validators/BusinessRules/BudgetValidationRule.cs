...
public class BudgetValidationRule : IBusinessRule
{
    ...
    public async Task<BusinessRuleResult> ValidateAsync(BusinessRuleContext context)
    {
        ...
        var periodo = new Periodo(
            new DateTime(context.Data.Year, context.Data.Month, 1),
            new DateTime(context.Data.Year, context.Data.Month, DateTime.DaysInMonth(context.Data.Year, context.Data.Month)));
